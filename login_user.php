...
<body style="background-image: url(&quot;app/img/classic-blue-coupe-die-cast-model-1037995.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;background-attachment: fixed;">
    <div class="container" style="width: 332px;margin-top: 120px;">
           <form style="width: 300px;" action="login_function_user.php" method="POST">
           <label class="d-xl-flex justify-content-xl-center" style="margin-bottom: 40px;">
            ...
            <label class="d-flex d-md-flex d-lg-flex justify-content-center justify-content-md-center justify-content-lg-center" style="margin-bottom: 20px;font-size: 20px;font-family: Montserrat, sans-serif;font-weight: bold;"><strong>Login into your account</strong></label>
            ...
            <div style="width: 300px;">
              ...
              <div class="d-flex d-md-flex d-xl-flex justify-content-center justify-content-md-center justify-content-xl-center" style="margin-bottom: 25px;font-size: 14px;font-family: Roboto, sans-serif;"><label>New to server?&nbsp;</label><a href="register_user.php"><span style="color: #009ace;">Create an account</span></a></div>
            </div>
        </form>
